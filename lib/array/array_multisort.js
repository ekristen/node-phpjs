module.exports = function array_multisort (arr) {
  ...
  // Fix: this module.exports = function must be fixed like asort(), etc., to return a (shallow) copy by default, since IE does not support!
  ...
  //        bit E: Turned on if either SORT_REGULAR, SORT_NUMERIC, or SORT_STRING was an argument. If already turned on, module.exports = function would return FALSE like in PHP.
  //        bit F: Turned on if either SORT_ASC or SORT_DESC was an argument. If already turned on, module.exports = function would return FALSE like in PHP.
  //        bit G and H: (Unused)
  //
  ...
  var argl = arguments.length,
    ...
    tmpArray = [],
    elIndex = 0,
    sortDuplicator = module.exports = function (a, b) {
  ...
  // First Argument should be either a Javascript Array or an Object, otherwise module.exports = function would return FALSE like in PHP
  ...
  // arrMainLength: Holds the length of the first array. All other arrays must be of equal length, otherwise module.exports = function would return FALSE like in PHP
  //
  ...
  for (i in sortArrs) {
    if (sortArrs.hasOwnProperty(i)) {
      ...
      // Sort module.exports = function for sorting. Either sorts asc or desc, regular/string or numeric.
