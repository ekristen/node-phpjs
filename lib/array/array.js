module.exports = function array () {
  ...
  var arrInst, e, __, that = this, PHPJS_Array = module.exports = function PHPJS_Array() {}, 
    mainArgs = arguments, p = this.php_js = this.php_js || {},
    _indexOf = module.exports = function (value, from, strict) {
  ...
  // BEGIN REDUNDANT
  if (!p.Relator) {
    p.Relator = (module.exports = function () {// Used this functional class for giving privacy to the class we are creating
      ...
      module.exports = function _indexOf (value) {
      ...
      module.exports = function Relator () {
        var Stack = [], Array = [];
        if (!Stack.indexOf) {
  ...
  if (p && p.ini && p.ini['phpjs.return_phpjs_arrays'].local_value.toLowerCase() === 'on') {    
    if (!p.PHPJS_Array) {
      ...
      p.PHPJS_Array = module.exports = function PHPJS_Array () {
        ...
        for (argl = args.length; i < argl; i++) {
          for (p in args[i]) {
            // Allow for access by key; use of private members to store sequence allows these to be iterated via for...in (but for read-only use, with hasOwnProperty or module.exports = function filtering to avoid prototype methods, and per ES, potentially out of order)
      ...
      e.change_key_case = module.exports = function (cs) {
      ...
      e.flip = module.exports = function () {
      ...
      e.walk = module.exports = function (funcname, userdata) {
      ...
      e.keys = module.exports = function (search_value, argStrict) {
      ...
      e.values = module.exports = function () {var _ = __.method(this);
        return _.values;
      };
      // Return non-object, non-array values, since most sensible
      e.search = module.exports = function (needle, argStrict) {
      ...
      e.foreach = module.exports = function (handler) {
        var _ = __.method(this), i = 0, kl = _.keys.length;
        while (i < kl) {
          if (handler.length === 1) {
      ...
      e.list = module.exports = function () {
      ...
      e.$object = module.exports = function () {var _ = __.method(this);
        return _.object;
      };
      e.$objectChain = module.exports = function () {var _ = __.method(this);
