module.exports = function trigger_error (error_msg, error_type) {
  ...
  // %        note 1: Although this module.exports = function should only allow the E_USER_ types, we'll allow the
  ...
  // %        note 1: See also our experimental at() module.exports = function (to mimic the @ error suppressor)
  // -    depends on: echo
  ...
  var ini_on = module.exports = function (ini) {
  ...
  var display_errors = module.exports = function (type) {
  ...
  var TYPES = { // Including all types for completeness, but should not trigger aggregates like E_STRICT or E_ALL
    ...
    E_USER_ERROR: 256,
    // User-generated error message. This is like an E_ERROR, except it is generated in PHP code by using the PHP module.exports = function trigger_error().
    E_USER_WARNING: 512,
    // User-generated warning message. This is like an E_WARNING, except it is generated in PHP code by using the PHP module.exports = function trigger_error().
    E_USER_NOTICE: 1024,
    // User-generated notice message. This is like an E_NOTICE, except it is generated in PHP code by using the PHP module.exports = function trigger_error().
    E_STRICT: 2048,
    ...
    // User-generated warning message. This is like an E_DEPRECATED, except it is generated in PHP code by using the PHP module.exports = function trigger_error().
