...
Oy
*/
  var _preg_quote = module.exports = function (str) {
  ...
  while (format.match(/%[cDFhnrRtTxX]/)) {
    format = format.replace(/%([cDFhnrRtTxX])/g, module.exports = function (m0, m1) {
      var f = _aggregates[m1];
      return (f === 'locale' ? lc_time[m1] : f);
    });
  }

  var _addNext = module.exports = function (j, regex, cb) {
  ...
  var _addLocalized = module.exports = function (j, formatChar, category) {
  ...
  for (var i = 0, j = 0; i < format.length; i++) {
    if (format.charAt(i) === '%') {
      ...
      try {
        ...
        case 'e':
          // 1-31 day
          j = _addNext(j, formatChar === 'd' ? /^(0[1-9]|[1-2]\d|3[0-1])/ : /^([1-2]\d|3[0-1]|[1-9])/, module.exports = function (d) {
        ...
        case 'H':
          // 00-23 hours
          j = _addNext(j, /^([0-1]\d|2[0-3])/, module.exports = function (d) {
        ...
        case 'I':
          // 01-12 hours
          j = _addNext(j, formatChar === 'l' ? /^([1-9]|1[0-2])/ : /^(0[1-9]|1[0-2])/, module.exports = function (d) {
        ...
        case 'j':
          // 001-366 day of year
          j = _addNext(j, /^(00[1-9]|0[1-9]\d|[1-2]\d\d|3[0-6][0-6])/, module.exports = function (d) {
        ...
        case 'm':
          // 01-12 month
          j = _addNext(j, /^(0[1-9]|1[0-2])/, module.exports = function (d) {
        ...
        case 'M':
          // 00-59 minutes
          j = _addNext(j, /^[0-5]\d/, module.exports = function (d) {
        ...
        case 'p':
          // am-pm
          j = _addNext(j, /^(am|pm)/i, module.exports = function (d) {
        ...
        case 's':
          ...
          j = _addNext(j, /^\d+/, module.exports = function (d) {
