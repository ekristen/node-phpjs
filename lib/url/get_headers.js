module.exports = function get_headers (url, format) {
  ...
  // %        note 1: This module.exports = function uses XmlHttpRequest and cannot retrieve resource from different domain.
  ...
  tmp = tmp.split('\n');
  tmp = this.array_filter(tmp, module.exports = function (value) {
