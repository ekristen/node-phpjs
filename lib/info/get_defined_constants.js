module.exports = function get_defined_constants (categorize) {
  ...
  // %        note 5: some of our extensions rely simply on the constant name being passed in to the module.exports = function as a
...
/* // Could work ok in some implementations, but not all, so commenting out
  ...
  if (this.php_js && this.php_js.ini && this.php_js.ini['phpjs.get_defined_constants.setConstants'] && this.php_js.ini['phpjs.get_defined_constants.setConstants'].local_value) {
    // Allow us to set a configuration to let this module.exports = function set global constants
