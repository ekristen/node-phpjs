module.exports = function str_getcsv (input, delimiter, enclosure, escape) {
  ...
  var output = [];
  var backwards = module.exports = function (str) { // We need to go backwards to simulate negative look-behind (don't split on
    //an escaped enclosure even if followed by the delimiter and another enclosure mark)
    return str.split('').reverse().join('');
  };
  var pq = module.exports = function (str) { // preg_quote()
