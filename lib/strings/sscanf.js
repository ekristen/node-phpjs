module.exports = function sscanf (str, format) {
  ...
  // %        note 1: Since JS does not support scalar reference variables, any additional arguments to the module.exports = function will
  ...
  var _setExtraConversionSpecs = module.exports = function (offset) {
  ...
  var _finish = module.exports = function () {
    if (args.length === 2) {
      return retArr;
    }
    ...
    if (format.charAt(i) === '%') {
      ...
      try {
        switch (format.charAt(i + 1)) {
          ...
          // p, S, C arguments in C module.exports = function not available
        ...
        case 'i':
          ...
          j = _addNext(j, /([+-])?(?:(?:0x([\da-fA-F]+))|(?:0([0-7]+))|(\d+))/, module.exports = function (num, sign, hex, oct, dec) {
        ...
        case 'd':
          ...
          j = _addNext(j, /([+-])?(?:0*)(\d+)/, module.exports = function (num, sign, dec) {
        ...
        case 'e':
          j = _addNext(j, /([+-])?(?:0*)(\d*\.?\d*(?:[eE]?\d+)?)/, module.exports = function (num, sign, dec) {
            if (dec === '.') {
              return null;
            }
        ...
        case 'o':
          ...
          j = _addNext(j, /([+-])?(?:0([0-7]+))/, module.exports = function (num, sign, oct) {
        ...
        case 'x':
          ...
          j = _addNext(j, /([+-])?(?:(?:0x)?([\da-fA-F]+))/, module.exports = function (num, sign, hex) {
