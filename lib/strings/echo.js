module.exports = function echo () {
  ...
  // *     returns 1: undefined
  // Fix: This module.exports = function really needs to allow non-XHTML input (unless in true XHTML mode) as in jQuery
  var arg = '',
  ...
  var stringToDOM = module.exports = function (str, parent, ns, container) {
    var extraNSs = '';
    if (ns === ns_xul) {
...
/*else if (win.XMLHttpRequest) { // Supposed to work in older Safari
  ...
  var ieFix = module.exports = function (node) {
    if (node.nodeType === 1) {
  ...
  var replacer = module.exports = function (s, m1, m2) {
