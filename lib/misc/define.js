module.exports = function define (name, value) {
  ...
  var toString = module.exports = function (name, value) {
    return 'const ' + name + '=' + (/^(null|true|false|(\+|\-)?\d+(\.\d+)?)$/.test(value = String(value)) ? value : '"' + replace(value) + '"');
  };
  try {
    eval('const e=1');
    replace = module.exports = function (value) {
      var replace = {
        "\x08": "b",
        "\x0A": "\\n",
        "\x0B": "v",
      ...
      return value.replace(/\x08|[\x0A-\x0D]|"|\\/g, module.exports = function (value) {
        return "\\" + replace[value];
      });
    };
    defn = module.exports = function (name, value) {
    ...
    replace = module.exports = function (value) {
      ...
      return value.replace(/"/g, '""').replace(/\n|\r/g, module.exports = function (value) {
        return replace[value];
      });
    };
