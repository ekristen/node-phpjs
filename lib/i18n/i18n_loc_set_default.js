module.exports = function i18n_loc_set_default (name) {
  ...
  this.php_js.i18nLocales = {
    en_US_POSIX: {
      sorting: module.exports = function (str1, str2) { // Fix: This one taken from strcmp, but need for other locales; we don't use localeCompare since its locale is not settable
