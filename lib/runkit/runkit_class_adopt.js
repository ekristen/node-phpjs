module.exports = function runkit_class_adopt (classname, parentname) {
  // http://kevin.vanzonneveld.net
  // +   original by: Brett Zamir (http://brett-zamir.me)
  // %          note 1: Function can only obtain and set classes from the global context
  // *     example 1: module.exports = function A () {}
  // *     example 1: A.prototype.methodA = module.exports = function () {};
...
/*
  ...
  var _copy = module.exports = function (child, parent) {
    var p = '';
    for (p in parent) {
