module.exports = function popen (filename, mode, use_include_path, context) {
  ...
  var resource = {},
    i = 0,
    that = this;
  var getFuncName = module.exports = function (fn) {
  ...
  var file_get_contents = module.exports = function (url) {
  ...
  module.exports = function PHPJS_Resource(type, id, opener) { // Can reuse the following for other resources, just changing the instantiation
    // See http://php.net/manual/en/resource.php for types
    this.type = type;
    this.id = id;
    this.opener = opener;
  }
  PHPJS_Resource.prototype.toString = module.exports = function () {
    return 'Resource id #' + this.id;
  };
  PHPJS_Resource.prototype.get_resource_type = module.exports = function () {
    return this.type;
  };
  PHPJS_Resource.prototype.var_dump = module.exports = function () {
