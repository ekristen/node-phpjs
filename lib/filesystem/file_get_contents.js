module.exports = function file_get_contents (url, flags, context, offset, maxLen) {
  ...
  // %        note 1: This module.exports = function uses XmlHttpRequest and cannot retrieve resource from different domain without modifications.
  ...
  var tmp, headers = [],
    ...
    content = null,
    http_stream = false;
  var func = module.exports = function (value) {
...
/*
          ...
          */
          ...
          req.onreadystatechange = module.exports = function (aEvt) { // aEvt has stopPropagation(), preventDefault(); see https://developer.mozilla.org/en/NsIDOMEvent
