...
/*
    *Trims string
    */
    trim = module.exports = function (text) {
...
/*
    ...
    */
    verify_type = module.exports = function (type) {
      var args = arguments,
...
/*
    ...
    */
    has_value = module.exports = function (array, value) {
      var i;
...
/*
    ...
    */
    are_type_of = module.exports = function (type) {
      var args = arguments,
        args_len = arguments.length,
        basic_types = ['number', 'boolean', 'string', 'function', 'object', 'undefined'],
        basic_type, i, j, type_of_type = typeof type;
...
/*
    ...
    */
    get_initialized_array = module.exports = function (array_size, init_value) {
      var array = [],
        i;
...
/*
    ...
    */
    split_into_lines = module.exports = function (text) {
    ...
    is_empty_array = module.exports = function (obj) {
...
/*
    ...
    */
    find_longest_common_sequence = module.exports = function (seq1, seq2, seq1_is_in_lcs, seq2_is_in_lcs) {
      ...
      var lcs_lens = module.exports = function (xs, ys) {
        ...
        find_lcs = module.exports = function (xs, xidx, xs_is_in, ys) {
          var nx = xs.length;
          var ny = ys.length;
          var i;
          var xb, xe;
  ...
  var leading_context = [],
    ...
    regularize_leading_context = module.exports = function (context) {
    ...
    regularize_trailing_context = module.exports = function (context) {
      if (context.length === 0 || context_lines === 0) {
        return [];
      }
