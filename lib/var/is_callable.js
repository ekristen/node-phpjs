module.exports = function is_callable (v, syntax_only, callable_name) {
  ...
  // *     example 3: module.exports = function SomeClass () {}
  // *     example 3: SomeClass.prototype.someMethod = module.exports = function (){};
  // *     example 3: var testObj = new SomeClass();
  // *     example 3: is_callable([testObj, 'someMethod'], true, 'myVar');
  // *     example 3: myVar;
  // *     returns 3: 'SomeClass::someMethod'
  // *     example 4: is_callable(module.exports = function () {});
  // *     returns 4: true
