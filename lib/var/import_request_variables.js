module.exports = function import_request_variables (types, prefix) {
  ...
  // %          note 1: especially if you want to use any of these variables in an eval()-like module.exports = function (not recommended)!
  ...
  var that = this;
  var _ini_get = module.exports = function (ini) {
