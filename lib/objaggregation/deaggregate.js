module.exports = function deaggregate (obj, class_name) {
  // http://kevin.vanzonneveld.net
  // +   original by: Brett Zamir (http://brett-zamir.me)
  // *     example 1: var A = module.exports = function () {};
  // *     example 1: A.prop = 5;
  // *     example 1: A.prototype.someMethod = module.exports = function () {};
  // *     example 1: var b = {};
  ...
  var p = '',
    ...
    pos = -1,
    i = 0,
    indexOf = module.exports = function (value) {
    ...
    getFuncName = module.exports = function (fn) {
